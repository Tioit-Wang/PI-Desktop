...
const copy = computed(() => isZh.value ? {
  ...
  journeys: [
    ...
    { index: '02', label: 'TRACE', title: '追踪一次请求', text: '从 Renderer 走到 Electron、pi、Rust host 和 SQLite。', link: '/zh-CN/spec/architecture/' },
    { index: '03', label: 'EXTEND', title: '开发一个插件', text: '从包格式、API、权限到生命周期逐步展开。', link: '/plugin-development' },
    { index: '04', label: 'SHIP', title: '验证一次变化', text: '把规格、实现、E2E 场景和交付记录连起来。', link: '/zh-CN/spec/delivery/' },
  ],
  mapLabel: '系统地图',
  ...
  shelves: [
    { title: '产品', text: '范围、操作模式和非目标。', link: '/zh-CN/spec/product/' },
    { title: '架构', text: '进程、数据和工程结构。', link: '/zh-CN/spec/architecture/' },
    { title: '运行时', text: '协议、工具、host 和模型。', link: '/zh-CN/spec/runtime/' },
    { title: '体验', text: '信息架构、国际化和交互。', link: '/zh-CN/spec/ux/' },
    { title: '安全', text: '权限、路径和隔离边界。', link: '/zh-CN/spec/security/' },
    { title: '交付', text: '验收、E2E 和发布。', link: '/zh-CN/spec/delivery/' },
    { title: '插件', text: '扩展包、API 和生命周期。', link: '/zh-CN/spec/plugins/' },
    { title: '决策', text: 'ADR、决策日志和开放问题。', link: '/zh-CN/spec/meta/' },
  ],
  snapshotLabel: '实现快照',
  ...
  footerSecondaryLink: '/zh-CN/spec/',
} : {
  eyebrow: 'PI-DESKTOP / DOCUMENTATION SYSTEM',
