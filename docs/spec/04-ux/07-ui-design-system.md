...
| Work panel width (open) | `364px–720px` (default 480px), fixed at the committed width | 44px activity rail preserves the prior 320px content minimum; the panel is an in-flow column and never expands the OS window (D154/D163, ADR 0033) |
...
- The work panel never participates in responsive collapse. It keeps its
  committed `364..720px` width (default 480px) while visible.
