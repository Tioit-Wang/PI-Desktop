...
- Authentication, model-selection, malformed-request, and context failures
  remain terminal. Other transient provider failures retain their existing one
  setup or mid-stream retry.
