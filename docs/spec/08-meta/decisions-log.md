...
- The sidecar keeps a complete local registry but sends only the mode's core
  ...
  always-active here until D199 removed the tool.)
...
- Decision D199 and ADR 0060 amend D158 / ADR 0030 / ADR 0049. See
