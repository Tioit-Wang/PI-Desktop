...
- Decision D234 extends D028/D031 and touches host-core secrets and providers,
  Electron main, the agent runtime's provider binding, and the settings UI.
  See ADR 0092 and `03-runtime/14-secrets-storage.md`.
