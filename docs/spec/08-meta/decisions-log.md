...
| D112 | Readable chat beside the work panel | *(dynamic width clamp superseded by D162; welcome chooser superseded by D128)* **MainChat has a 360px readability target beside the panel. D162 preserves it through native width reservation whenever the display work area can supply the complete committed panel width; otherwise MainChat absorbs the unavoidable shortfall while the panel remains fixed.** | A panel-only width cap could leave roughly 109–205px for chat at supported window sizes; native reservation now preserves chat without compressing the tool surface. |
...
- Maximized/fullscreen geometry waits for normal state. Persisted base bounds
  ...
  visible target.
- Decision D162; ADR 0032. This supersedes the contrary portions of D156 and
  ADR 0029.
