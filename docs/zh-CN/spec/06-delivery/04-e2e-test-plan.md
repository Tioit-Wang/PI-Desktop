...
- **步骤**：
  ...
  5. 点击文本文件，确认查看器显示返回、相对路径、文件大小、行号、有界文本和“使用默认应用打开”。点击该操作，确认文件在操作系统的关联应用中打开。点击二进制文件，确认它显示不可预览，而不是打印替换字符；同一操作仍应使用其关联应用打开。切换到简体中文，确认工具栏、空状态、加载/错误状态、查看器和打开操作均已本地化。
...
- **链接规格**：`07-plugins/03-plugin-api.md` §3、`07-plugins/13-plugin-permissions-matrix.md` §2、`04-ux/08-component-spec.md` §5、ADR 0104、ADR 0105、ADR 0109
