...
- **步骤**：
  ...
  4. 确认工具栏显示项目名称和“刷新”操作；用鼠标和键盘展开目录，确认目录行暴露展开状态、文件夹排在文件前面，加载失败的目录提供原地“重试”。
  5. 点击文本文件，确认查看器显示返回、相对路径、文件大小、行号和有界文本；点击二进制文件，确认它显示不可预览，而不是打印替换字符。切换到简体中文，确认工具栏、空状态、加载/错误状态和查看器文案均已本地化。
...
- **链接规格**：`07-plugins/03-plugin-api.md` §3、`07-plugins/13-plugin-permissions-matrix.md` §2、`04-ux/08-component-spec.md` §5、ADR 0104、ADR 0105
- **接受**：G（插件）、D（工作区）、安全性、品质
- **里程碑**：M6+
- **状态**：`apps/desktop/test/bundled-plugins.test.mjs` 已覆盖插件归属和界面契约；完整打包旅程为草稿（除非明确要求，否则不要在本地运行 E2E）
...
| G——插件 | E2E-022、E2E-022A、E2E-022B、E2E-022C、E2E-023、E2E-024、E2E-024B、E2E-024C、E2E-024D、E2E-024E、E2E-024F、E2E-024G、E2E-024H、 E2E-024I、E2E-024J、E2E-024K、E2E-024L、E2E-024M、E2E-024N、E2E-024O、E2E-024P、E2E-025、E2E-026、E2E-105、E2E-117、E2E-120、E2E-122、E2E-123、E2E-148、E2E-153 |
