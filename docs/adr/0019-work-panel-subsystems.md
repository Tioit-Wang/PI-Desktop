...
- Related: [01-ui-ia](../spec/04-ux/01-ui-ia.md) · [08-component-spec §5](../spec/04-ux/08-component-spec.md) · [01-ipc-protocol §13a](../spec/03-runtime/01-ipc-protocol.md) · decisions D097–D100

## Context

The Codex-parity shell needs a docked right work panel with four tabs —
Review (working-tree diff), Terminal (interactive), Browser (preview), and
Files (workspace browsing). Each tab needs a backend capability that the
...
All four capabilities are implemented in the **Electron main process**,
