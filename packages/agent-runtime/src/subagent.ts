 ...
 *   runs in the background under the session runtime (ADR 0087): `Task`
...
/** Converge on running delegations and read their reports (ADR 0087). */
export const SUBAGENT_WAIT_TOOL_NAME = "TaskWait";
/** Report on the session's delegations without waiting (ADR 0087). */
export const SUBAGENT_LIST_TOOL_NAME = "TaskList";
/** Stop running delegations (ADR 0087). */
