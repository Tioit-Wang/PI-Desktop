export const en = {
  ...
  chat: {
    ...
    abort: "Stop",
    running: "Working…",
    progressUnderstanding: "Understanding the task",
    progressWorking: "Working through the project",
    progressWorkingWith: "Working with {{tool}}",
    progressChecking: "Checking the result",
    progressFinalizing: "Putting it together",
    progressWaiting: "Waiting for your approval",
    copy: "Copy",
    copied: "Copied",
    ...
    resultFilesChanged_one: "1 file changed",
    resultFilesChanged_other: "{{count}} files changed",
