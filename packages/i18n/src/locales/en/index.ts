export const en = {
  ...
  settings: {
    ...
    account: "Account",
    skills: "Skills",
    skillsDescription: "Reusable instructions the agent can load when a task needs them.",
    skillsGlobalPath: "Global skills path",
    skillsProjectPath: "Project skills path",
    mcp: "MCP servers",
    mcpDescription: "Connect the agent to local commands and remote services.",
    mcpGlobalPath: "Global MCP path",
    mcpProjectPath: "Project MCP path",
    subagents: "Subagents",
    subagentsDescription: "Personal delegates the agent can call for bounded parallel work.",
    ...
    mcpProjectSubtitle: "Configured for {{project}}. This server is only active in the selected project.",
    ...
    transportHttp: "http",
    scope: "Scope",
    scopeHint: "Choose where this capability is active.",
    ...
    apiStyle: "API format",
    apiStyleDesc: "The API format determines the request protocol and must match the service.",
    ...
    selectModelsPlaceholder: "Select models (multiple allowed)",
    nModelsSelected: "{{n}} models selected",
    modelsEmptyHint: "Enter the base URL and API key to fetch the model list…",
    ...
    modelConfigurationsDesc: "Tune limits and thinking support for each selected model.",
    ...
    cardDefaultsHint: "Defaults are filled from the built-in model catalog and can be changed",
    cardCustomDefaultsHint: "Custom models use fallback defaults and can be changed",
