export const en = {
  ...
  menu: {
    ...
    refreshMarket: "Refresh from repo",
    marketRefreshed: "Marketplace refreshed ({{count}} plugins)",
  ...
  chat: {
    ...
    fileTruncated: "Showing the first 8000 indexed entries",
  ...
  plugins: {
    title: "Plugins",
    subtitle: "Browse the official plugin warehouse, inspect README/changelog/versions, and install with permission review.",
    loadDev: "Load dev plugin",
    loadDevDone: "Development plugin loaded",
    installPackage: "Install .piplug",
    installPackageDone: "Plugin package installed",
    enable: "Enable",
    disable: "Disable",
    uninstall: "Uninstall",
    empty: "No plugins installed",
    emptyBody: "Browse the marketplace or load a local plugin folder to register commands, panels, and tools.",
    tabInstalled: "Installed",
    tabMarket: "Marketplace",
    browseMarket: "Browse marketplace",
    checkUpdates: "Check updates",
    applyAutoUpdates: "Apply auto-updates",
    updatesFound: "{{count}} update(s) available",
    autoUpdatesApplied: "Applied {{count}} auto-update(s)",
    marketSearchPlaceholder: "Search marketplace plugins",
    refreshMarket: "Refresh from repo",
    marketRefreshed: "Marketplace refreshed ({{count}} plugins)",
    marketSource: "Source: {{url}}",
    search: "Search",
    marketLoading: "Loading marketplace…",
    marketEmpty: "No marketplace plugins matched",
    verified: "Verified",
    ...
    permissionReviewBody: "Review the permissions this plugin is requesting. High-risk capabilities stay blocked unless you accept them here.",
    ...
    detailFailed: "Failed to load plugin details",
    ...
    permissions: {
      "ui.panel": "Open plugin panel",
      "clipboard.read": "Read clipboard",
      "clipboard.write": "Write clipboard",
      "notify": "Show notifications",
      "fs.read.workspace": "Read project files",
      "fs.write.workspace": "Modify project files",
      "agent.tool.register": "Register agent tools",
      "agent.prompt.inject": "Inject agent prompts",
      "net.fetch": "Access the network",
      "shell.openExternal": "Open external links",
    },
    permissionHelp: {
      "ui.panel": "Allows the plugin to show an isolated UI panel.",
      "clipboard.read": "May read sensitive clipboard contents.",
      "clipboard.write": "May overwrite clipboard contents.",
      ...
      "agent.tool.register": "Exposes executable tools to the AI agent.",
      "agent.prompt.inject": "Can alter agent instructions.",
