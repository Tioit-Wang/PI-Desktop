export const en = {
  ...
  settings: {
    ...
    modelConfigEyebrow: "Model configuration",
    modelConfigTitle: "Connect PI-Desktop to your AI services",
    modelConfigDesc:
      "Keep API-based services and vendor subscriptions in separate spaces, while choosing either as the default model source.",
    modelConfigSummary: "Model configuration summary",
    modelConfigServiceCount: "AI services",
    modelConfigAccountCount: "Connected accounts",
    ...
    vendorAccountsDesc:
      "Manage subscription accounts separately from API services. Add the same vendor more than once when you use multiple accounts.",
    ...
    providersDesc: "API-key and custom endpoint configurations. Vendor subscriptions are managed above.",
