export const en = {
  ...
  settings: {
    ...
    instructionsProject: "Project instructions",
    instructionsProjectDesc: "Applied to the current project and committed with it when tracked by Git.",
    instructionsPath: "Instruction file path",
    instructionsNoProject: "Open a project to manage its AGENTS.md.",
