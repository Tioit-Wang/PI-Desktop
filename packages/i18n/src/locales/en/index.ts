export const en = {
  ...
  settings: {
    ...
    vendorAccountsDesc:
      "Sign in with a subscription you already pay for instead of pasting an API key.",
    vendorSignIn: "Sign in",
    vendorSignOut: "Sign out",
    vendorAddAccount: "Add account",
    vendorNoAccounts: "No vendor account is signed in yet.",
    vendorAllSignedIn: "Every vendor this build knows is already signed in.",
    vendorPickTitle: "Choose a vendor",
    vendorPickDesc: "Pick the subscription you want to sign in with.",
    vendorSignInTo: "Sign in to {{vendor}}",
    vendorConnected: "Connected",
    vendorSubscription: "Subscription",
    vendorSignedInGeneric: "Signed in",
    vendorAccountBadge: "Vendor account",
