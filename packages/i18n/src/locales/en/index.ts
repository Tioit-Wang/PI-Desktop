export const en = {
  ...
  chat: {
    ...
    startersTitle: "Start with a task",
    starterExploreTitle: "Explore a codebase",
    starterExploreDescription: "Map the important files and find where to start",
    starterExplorePrompt: "Explore this project and tell me where I should start.",
    starterBuildTitle: "Build a feature",
    starterBuildDescription: "Turn an idea into a clear implementation plan",
    starterBuildPrompt: "Help me design and build a new feature. Start with a plan.",
    starterFixTitle: "Fix a bug",
    starterFixDescription: "Trace an issue and apply a focused fix",
    starterFixPrompt: "Help me find and fix a bug. Start by analyzing the likely cause.",
    starterReviewTitle: "Review a change",
    starterReviewDescription: "Check for bugs, risks, and missing tests",
    starterReviewPrompt: "Review the current changes for bugs, risks, and missing tests.",
  ...
  extensions: {
    ...
    subagents: {
      title: "Subagents",
      subtitle: "Delegates the agent can hand one task to — a reviewer, an explorer, a test runner — each with its own prompt and its own tool grant.",
      add: "New subagent",
      ...
      emptyBody: "Write one for work you keep delegating by hand, or copy a built-in below and change it.",
      ...
      providedSubtitle: "What the agent can delegate to in this project besides your own. Read-only — copy one to make it yours.",
