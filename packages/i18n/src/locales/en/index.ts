export const en = {
  ...
  settings: {
    ...
    editProviderDesc:
      "Changes apply from the next message — running sessions pick them up automatically.",
    ...
    providersHeroKicker: "Model studio",
    providersHeroTitle: "Connect models once, use them everywhere",
    providersHeroDesc: "Add OpenAI-compatible providers, set a default model, and keep API keys sealed in secure storage.",
    providersSummary: "Provider summary",
    providersCount: "Providers",
    providersReady: "Ready",
    noDefaultProvider: "No default",
    providersSectionDesc: "Manage gateways, default model IDs, and thinking support for each provider.",
    hideAddProvider: "Hide form",
    addProviderTitle: "New OpenAI-compatible provider",
    addProviderDesc: "Works with OpenRouter, DeepSeek, local gateways, corporate proxies, and any Chat Completions endpoint.",
