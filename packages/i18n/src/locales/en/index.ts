export const en = {
  ...
  settings: {
    ...
    defaultPermissionsDesc: "By default, the agent can read and edit files in its workspace. It can request extra access when needed.",
    autoReview: "Auto-review",
    autoReviewDesc: "Automatically review extra access requests. Auto-review can make mistakes.",
    fullAccess: "Full access permissions",
    fullAccessDesc: "When running with full access, the agent can edit any file and run network commands without approval.",
    showMenuBar: "Show in menu bar",
    showMenuBarDesc: "Keep the app in the macOS menu bar when the main window is closed.",
