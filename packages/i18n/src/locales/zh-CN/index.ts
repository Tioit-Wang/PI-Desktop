...
export const zhCN = {
  ...
  settings: {
    ...
    providersHeroDesc: "添加 OpenAI 兼容提供方，设置默认模型，并把 API 密钥保存在安全存储中。",
    providersSummary: "提供方摘要",
    providersCount: "提供方",
    providersReady: "就绪",
    noDefaultProvider: "未设置默认",
    providersSectionDesc: "管理网关、默认模型 ID，以及每个提供方的思考能力。",
    hideAddProvider: "收起表单",
    addProviderTitle: "新建 OpenAI 兼容提供方",
    addProviderDesc: "适用于 OpenRouter、DeepSeek、本地网关、企业代理，以及任何 Chat Completions 端点。",
    openaiCompatible: "OpenAI 兼容",
    apiKeyHint: "安全保存。保存后不会再次展示原始密钥。",
    cancel: "取消",
    noProvidersDesc: "添加提供方后，即可使用聊天、Agent 运行和模型选择。",
    testing: "测试中…",
    testOk: "连接正常",
    testFailed: "连接测试失败",
