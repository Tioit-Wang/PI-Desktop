...
export const zhCN = {
  ...
  settings: {
    ...
    defaultsTitle: "默认项",
    modelConfigEyebrow: "模型配置",
    modelConfigTitle: "连接 PI-Desktop 的 AI 服务",
    modelConfigDesc:
      "将 API 服务与厂商订阅账户分开管理，同时仍可把任意一方设为默认模型来源。",
    modelConfigSummary: "模型配置概览",
    modelConfigServiceCount: "AI 服务",
    modelConfigAccountCount: "已连接账户",
    defaultModel: "默认模型",
    ...
    vendorAccounts: "厂商账户",
    vendorAccountsDesc:
      "厂商订阅账户与 API 服务分开管理；同一厂商可以添加多个独立账户。",
    ...
    providersDesc: "管理 API 密钥和自定义接口；厂商订阅账户在上方单独管理。",
    application: "应用",
