...
export const zhCN = {
  ...
  chat: {
    ...
    abort: "停止",
    running: "正在处理…",
    progressUnderstanding: "正在理解任务",
    progressWorking: "正在处理项目",
    progressWorkingWith: "正在使用 {{tool}}",
    progressChecking: "正在检查结果",
    progressFinalizing: "正在整理结果",
    progressWaiting: "正在等待你的确认",
    copy: "复制",
    copied: "已复制",
    ...
    resultFilesChanged_one: "改动了 1 个文件",
    resultFilesChanged_other: "改动了 {{count}} 个文件",
