...
export const zhCN = {
  ...
  settings: {
    ...
    selectModels: "选择模型",
    selectModelsPlaceholder: "选择模型（可多选）",
    nModelsSelected: "已选 {{n}} 个模型",
    modelsEmptyHint: "填写地址与密钥后自动获取模型列表…",
    modelsFetching: "正在获取模型列表…",
    customModel: "自定义",
    ...
    modelConfigurationsDesc: "为每个已选模型调整上下文、输出和思考支持。",
    builtInCatalog: "内置目录",
    removeModel: "移除模型",
    contextWindow: "上下文窗口",
    maxOutput: "最大输出",
    ...
    notSupported: "不支持",
    cardDefaultsHint: "默认值来自内置模型目录，可按需修改。",
    cardCustomDefaultsHint: "自定义模型已应用默认参数，可按需修改。",
