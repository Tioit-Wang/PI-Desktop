...
export const zhCN = {
  ...
  chat: {
    ...
    startersTitle: "从一个任务开始",
    starterExploreTitle: "了解一个项目",
    starterExploreDescription: "梳理关键文件，找到适合开始的位置",
    starterExplorePrompt: "先帮我了解这个项目的结构，并告诉我从哪里开始。",
    starterBuildTitle: "实现一个功能",
    starterBuildDescription: "把想法整理成清晰的实现计划",
    starterBuildPrompt: "帮我设计并实现一个新功能，先给出计划。",
    starterFixTitle: "修复一个问题",
    starterFixDescription: "定位原因并完成一次聚焦修复",
    starterFixPrompt: "帮我定位并修复一个问题，先分析可能的原因。",
    starterReviewTitle: "审查一段改动",
    starterReviewDescription: "检查 Bug、风险和遗漏的测试",
    starterReviewPrompt: "请审查当前改动，重点检查 Bug、风险和遗漏的测试。",
  ...
  plugins: {
    ...
    updatesReadyBody: "更新前请先确认：新版本可能会申请新的权限。",
    ...
    marketEmpty: "没有匹配的插件",
    marketEmptyBody: "检查一下拼写，或清除搜索查看全部插件。",
    categories: "分类",
    categoryAll: "全部",
    verified: "已验证",
    downloads: "{{count}} 次安装",
  ...
  extensions: {
    ...
    mcp: {
      title: "MCP 服务器",
      subtitle: "接入 Model Context Protocol 服务器，它提供的工具会直接交给智能体使用，无需插件。",
      add: "添加服务器",
      addTitle: "添加 MCP 服务器",
      ...
      empty: "还没有 MCP 服务器",
      emptyBody: "添加一个，就能把另一个程序的能力交给智能体——数据库、浏览器、任务系统都可以。",
    ...
    skills: {
      title: "技能",
      subtitle: "一些简短的文档，智能体在需要时自己打开——检查清单、团队规范、发版步骤都可以。",
      add: "新建技能",
      addTitle: "新建技能",
      editTitle: "编辑技能",
      ...
      import: "导入文件",
      empty: "还没有技能",
      emptyBody: "把你反复解释的事情写下来，智能体就能去查，而不是靠猜。",
    ...
    subagents: {
      title: "子智能体",
      subtitle: "可以把单个任务交给它们去做的分身——审阅、探索、跑测试，各自有独立的提示词和工具权限。",
      add: "新建子智能体",
      addTitle: "新建子智能体",
      editTitle: "编辑子智能体",
      ...
      sheetNote: "保存为 markdown 文件，也可以在应用外编辑。",
      empty: "还没有你自己的子智能体",
      emptyBody: "把你反复手动交代的活写成一个，或者复制下面的内置定义再改。",
      ...
      providedTitle: "内置与项目",
      providedSubtitle: "在当前项目里，除你自己的定义之外还能委派的对象。只读——复制一份即可改成自己的。",
      sourceBuiltin: "内置",
      sourceProject: "项目",
      name: "名称",
      ...
      maxTurns: "轮次上限",
      maxTurnsHint: "用来兜住停不下来的子智能体。1–{{max}}。",
      body: "指令",
