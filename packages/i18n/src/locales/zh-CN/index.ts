...
export const zhCN = {
  ...
  menu: {
    ...
    selectAll: "全选",
    refreshMarket: "从仓库刷新",
    marketRefreshed: "市场已刷新（{{count}} 个插件）",
    marketSource: "来源：{{url}}",
    search: "搜索…",
    commandPalette: "命令面板…",
    toggleSidebar: "侧边栏",
  ...
  plugins: {
    title: "插件",
    subtitle: "浏览官方插件仓库，查看 README / 更新日志 / 版本列表，并在权限确认后安装。",
    loadDev: "加载开发插件",
    loadDevDone: "开发插件已加载",
    installPackage: "安装 .piplug",
    installPackageDone: "插件包已安装",
    enable: "启用",
    disable: "禁用",
    uninstall: "卸载",
    empty: "未安装插件",
    emptyBody: "可浏览插件市场，或加载本地插件目录以注册命令、面板与工具。",
    tabInstalled: "已安装",
    tabMarket: "插件市场",
    browseMarket: "浏览市场",
    checkUpdates: "检查更新",
    ...
    marketSearchPlaceholder: "搜索市场插件",
    refreshMarket: "从仓库刷新",
    marketRefreshed: "市场已刷新（{{count}} 个插件）",
    marketSource: "来源：{{url}}",
    search: "搜索",
    marketLoading: "正在加载市场…",
    ...
    permissionReviewBody: "请确认该插件申请的权限。高风险能力只有在你接受后才会开放。",
    acceptInstall: "接受并安装",
    cancel: "取消",
    viewDetails: "详情",
    detailTitle: "插件详情",
    ...
    permissions: {
      ...
      "agent.prompt.inject": "注入 Agent 提示",
      "net.fetch": "访问网络",
      "shell.openExternal": "打开外部链接",
    },
    permissionHelp: {
      "ui.panel": "允许插件显示隔离的 UI 面板。",
      "clipboard.read": "可能读取剪贴板中的敏感内容。",
      "clipboard.write": "可能覆盖剪贴板内容。",
      "notify": "可显示本地通知。",
      "fs.read.workspace": "仅可读取当前项目内文件。",
      "fs.write.workspace": "可创建或修改当前项目文件。",
      "agent.tool.register": "向 AI Agent 暴露可执行工具。",
      "agent.prompt.inject": "可修改 Agent 指令。",
      "net.fetch": "可发起出站网络请求。",
