...
export const zhCN = {
  ...
  settings: {
    ...
    editProviderDesc: "修改从下一条消息开始生效，进行中的会话会自动切换。",
    ...
    fetchModelsCount: "获取到 {{count}} 个模型",
    fetchModelsCount_one: "获取到 1 个模型",
    fetchModelsCount_other: "获取到 {{count}} 个模型",
    ...
    enabledToggle: "启用",
    disabledBadge: "已停用",
    providersHeroKicker: "模型工作室",
    providersHeroTitle: "一次连接，全局可用",
    providersHeroDesc: "添加 OpenAI 兼容提供方，设置默认模型，并将 API 密钥保存在安全存储中。",
    providersSummary: "提供方摘要",
    providersCount: "提供方",
    providersReady: "就绪",
    noDefaultProvider: "未设置默认",
    providersSectionDesc: "管理网关、默认模型，以及每个提供方的思考能力。",
    hideAddProvider: "收起表单",
    addProviderTitle: "新建 OpenAI 兼容提供方",
    addProviderDesc: "适用于 OpenRouter、DeepSeek、本地网关、企业代理，以及任何 Chat Completions 接口。",
