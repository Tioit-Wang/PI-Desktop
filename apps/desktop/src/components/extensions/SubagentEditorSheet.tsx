...
export function draftFromRecord(
  ...
  return {
    ...
    maxTurns: record.maxTurns ?? DEFAULT_SUBAGENT_MAX_TURNS,
    body,
...
/**
 * Seed a draft from a definition the user cannot edit — a builtin or a project
 * document. The name carries over as-is: the copy would be shadowed by whatever
 * it was copied from, which the section tells the user, and renaming it here
 * before saving is the fix.
 */
export function draftFromDefinition(
  ...
  return {
    ...
    model: definition.model ? subagentModelKey(definition.model) : "",
      ...
      >
        ...
        <div className="ext-sheet-body">
          ...
          <div className="ext-field-group">
            ...
            <div className="ext-tool-pick" role="group" aria-label={t("extensions.subagents.tools")}>
          ...
          <div className="ext-field-group">
            ...
            <ScopeControl
              ...
              label={draft.name || t("extensions.subagents.thisSubagent")}
              projects={projects}
