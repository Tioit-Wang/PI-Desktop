 ...
 * would already work. An empty editor teaches nothing about the format; front
 * matter plus a heading and steps is the shape every good skill has.
 */
      ...
      <div className="dialog ext-sheet" role="dialog" aria-modal aria-labelledby="skill-sheet-title">
        ...
        <div className="ext-sheet-body">
          <Field
            ...
            hint={slug ? t("extensions.skills.slugHint", { id: slug }) : t("extensions.skills.nameHint")}
          >
            <Input
              value={draft.name}
              autoFocus={!editing}
          ...
          <div className="ext-field-group">
            ...
            <ScopeControl
              ...
              label={draft.name || t("extensions.skills.thisSkill")}
              projects={projects}
